			...
			<div class="row">
				...
				<div class="alert alert-${alert}">
					...
					<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
						...
						<div class="form-group">
							  <label class="col-sm-3 control-label no-padding-right" for="comment">Mô tả ngắn</label>
							  <div class="col-sm-9">
							 	 <form:textarea path="shortDescription" rows="5" cols="10" id="shortDescription" cssClass="form-control"/>
							  </div>
						</div>
						<div class="form-group">
							  <label class="col-sm-3 control-label no-padding-right" for="comment">Nội dung</label>
							  <div class="col-sm-9">
